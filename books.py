    ...
    if request.method == 'POST':
        ...
        if file and file.filename != '':
            if allowed_file(file.filename):
                ...
                flash('Недопустимый формат файла. Разрешены: pdf, epub, doc, docx, txt', 'danger')
...
def download(id):
    ...
    return send_from_directory(directory, filename, as_attachment=True, download_name=book.file_name)
